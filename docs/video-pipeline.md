...
Generation goes through the proven skills' runner — this repo wraps it, never
reimplements it.
...
Studio entry: `design_studio.py generate` (see docs/studio-cli.md).
...
- Cancelling: killing run_h3.py does NOT stop the queued job — /interrupt or
  /queue delete in ComfyUI
